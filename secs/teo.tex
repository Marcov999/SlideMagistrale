...
\begin{frame}[t]{I domini Caltrops sono $(\lambda,\kappa)$-visibili}
  \only<1-7>{
    Sia $\Omega$ un dominio limitato di $\mathbb{C}^n$. Poniamo
    ...
    \begin{block}{Teorema (Bharali, Maitra, 2021)}\begin{itshape}
      Sia $\Omega$ un dominio limitato di $\mathbb{C}^n$. \setcounter{beamerpauses}{2}\pause Supponiamo che esistano uno $z_0\in\Omega$ e una funzione $C^1$ strettamente crescente $f:(0,+\infty)\longrightarrow\mathbb{R}$, con $f(t)\longrightarrow+\infty$ per $t\longrightarrow+\infty$, tali che:\pause
      \begin{enumerate}
